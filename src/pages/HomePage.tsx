...
const Section_9009b281 = (() => {
  ...
  // If "business" is set it shows "Verificeret Google-anmeldelse · Virksomhedsnavn".
  ...
  function ReviewCard({ review }: { review: ReviewData }) {
    ...
    const metaLabel = review.business
      ? `Verificeret Google-anmeldelse · ${review.business}`
      : 'Verificeret Google-anmeldelse';
    const googleLink =
      review.link ||
