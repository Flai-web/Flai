        ...
        <section className="py-20">
          ...
          <div className="container">
            <div
              ...
              style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '300px 1fr' }}
            >
              <div style={{ background: '#0F52BA' }} className="p-10 flex flex-col gap-5 border-r border-blue-700">
                <div className="testi-skel" style={{ height: 12, width: 72, background: '#3A70C9' }} />
                <div className="testi-skel" style={{ height: 44, width: '85%', background: '#3A70C9' }} />
                <div className="testi-skel" style={{ height: 12, width: '60%', background: '#2F62B5' }} />
                <div style={{ display: 'flex', gap: 10, marginTop: 'auto' }}>
                  <div className="testi-skel" style={{ width: 38, height: 38, borderRadius: '50%', background: '#3A70C9' }} />
                  <div className="testi-skel" style={{ width: 38, height: 38, borderRadius: '50%', background: '#3A70C9' }} />
                </div>
              </div>
              <div className="bg-neutral-800 p-10 flex flex-col gap-4">
          ...
          <div className="container">
            ...
            >
              <div style={{ background: '#0F52BA' }} className="p-10 border-r border-blue-700">
                <p style={{ fontSize: '0.68rem', fontWeight: 700, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#FFFFFF', marginBottom: 12 }}>Anmeldelser</p>
                <h2 style={{ fontSize: 'clamp(1.75rem,2.8vw,2.4rem)', fontWeight: 800, color: '#ffffff', lineHeight: 1.1, letterSpacing: '-0.03em', margin: 0 }}>
                  Fra vores <span style={{ color: '#FFFFFF', fontWeight: 300 }}>kunder.</span>
                </h2>
              </div>
              <div className="bg-neutral-800 p-10 flex items-center justify-center">
    ...
    return (
      <section className="py-20">
        <style>{`
          ...
          @media (max-width: 768px) {
            .testi-left  { padding: 32px 24px; }
            .testi-right { padding: 32px 24px; }
          }

          /* Left panel text — Pure solid white to remove any transparent illusion */
          .testi-label {
            font-size: 0.68rem;
            font-weight: 700;
          ...
          /* Right panel - Solid bright blue quote to fix transparent look */
          .big-quote {
            font-size: 5rem;
            line-height: 0.7;
            color: #3B82F6; 
        ...
        <div className="container">
          <div className="testi-grid">
            ...
            <div className="testi-left">
              <div>
                <p className="testi-label">Anmeldelser</p>
                <h2 className="testi-heading">
                  Fra vores <em>kunder.</em>
                </h2>
                <p className="testi-subtext">
                  Her er hvad andre har sagt om deres oplevelse med os.
                </p>
              </div>
            ...
            <div className="testi-right">
              ...
              {/* Progress bar only shows when there are multiple reviews */}
              {reviews.length > 1 && (
