...
const Section_9009b281 = ((
  ...
  const Testimonials: React.FC = () => {
    ...
    const navActive = isDesktop ? reviews.length > 2 : reviews.length > 1;
    ...
    const navigate = useCallback(
      ...
      [navActive, isAnimating, reviews.length]
    );
    ...
    }, [currentIndex, reviews, handleNext, navActive]);
    ...
    return (
      <section className="py-20">
        <style>{`
          ...
          /* ── Nav + progress bar visibility per breakpoint ── */
          @media (min-width: 769px) {
        ...
        <div className="w-full max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="testi-outer">
            ...
            {/* ── Progress bar — outside nav row, with top margin for spacing ── */}
            <div
              className={[
                'testi-progress-wrapper',
