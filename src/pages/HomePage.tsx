...
const Section_9009b281 = ((
  ...
  const Testimonials: React.FC = () => {
    ...
    // ── Counter values ─────────────────────────────────────────────────────────
    // currentIndex always steps by DESKTOP_PER_PAGE (2), so normalise to a
    // 1-based page number that increments by 1 on each press on both breakpoints.
    const currentPage = Math.floor(currentIndex / DESKTOP_PER_PAGE) + 1;
    const totalPages  = Math.ceil(reviews.length / DESKTOP_PER_PAGE);
