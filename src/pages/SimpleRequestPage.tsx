...
const SimpleRequestPage: React.FC = () => {
  ...
  const bookingIdRef = useRef<number | null>(null); // reliable cross-closure ref
  ...
  const createPaymentIntent = async () => {
    ...
    // Store in both state and ref — state for renders, ref for callbacks
  ...
  // and handlePaymentComplete would read null if it captured the old closure.
  // The supabase client also correctly handles RLS, unlike a raw anon-key fetch.
