        ...
        >
          {index === 0 && (
            <span className="absolute top-1 left-1 z-10 bg-primary text-white text-[10px] font-bold px-1.5 py-0.5 rounded pointer-events-none">
              <EditableContent contentKey="products-manager-cover" fallback="Cover" /></span>
          )}
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <button onClick={() => addLink(true)} className="text-sm text-primary hover:text-primary-dark" disabled={editingProduct.links.length >= 4}><EditableContent contentKey="products-manager-tilfoej-link-2" fallback="+ Tilføj Link" /></button>
                    </div>
