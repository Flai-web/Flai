    ...
    <div className="space-y-6">
      ...
      {showAddForm && (
        <div className="bg-neutral-700/20 rounded-lg p-6 space-y-4">
          ...
          <div className="flex justify-end space-x-3">
            <button
              onClick={() => { setShowAddForm(false); setNewImage({ title: '', image_url: '', description: '' }); }}
              className="btn-secondary"
            >
              Annuller
            </button>
                          ...
                          <div className="relative bg-neutral-700/20 rounded-lg overflow-hidden border-2 border-primary/40">
                            {editingImage?.id === bundleImage.id ? (
                              <div className="p-4 space-y-3">
                                ...
                                <div>
                                  <label className="form-label text-sm">Billede / Video</label>
                                  <ImageUpload
                                ...
                                <div className="bg-neutral-800/30 rounded-lg p-3">
                                  <div className="flex items-center mb-2">
                                    ...
                                    <span className="text-xs font-medium text-neutral-400">Rækkefølge</span>
                                  </div>
                                  <input
                                    type="number"
                                  ...
                                  <div className="space-y-1">
                                    <div className="flex items-center justify-between text-xs text-neutral-400">
                                      <span>0</span>
                                      <span className="font-medium text-neutral-300">Værdi: {editingImage.array ?? 0}</span>
                                ...
                                <div className="p-3">
                                  ...
                                  <div className="bg-neutral-800/30 rounded-lg p-3">
                                    ...
                                    <div className="space-y-1">
                                      <div className="flex items-center justify-between text-xs text-neutral-400">
                                        <span>0</span>
                                        <span className="font-medium text-neutral-300">Værdi: {sliderValues[bundleImage.id] ?? bundleImage.array ?? 0}</span>
                                        <span>Højest ({arrayBounds.max})</span>
                                      </div>
                                      <input
                                        type="range" min={0} max={arrayBounds.max}
                    ...
                    <div className="p-6 space-y-4">
                      ...
                      <div className="bg-neutral-800/30 rounded-lg p-4">
                        <div className="flex items-center mb-3">
                          ...
                          <span className="text-sm font-medium text-neutral-400">Rækkefølge</span>
                        </div>
                        <input
                          type="number"
                          value={editingImage.array ?? 0}
                      ...
                      <div className="p-4">
                        ...
                        <div className="bg-neutral-800/30 rounded-lg p-4">
                          ...
                          <div className="space-y-2">
                            <div className="flex items-center justify-between text-xs text-neutral-400">
                              <span>0</span>
                              <span className="font-medium text-neutral-300">Værdi: {sliderValues[image.id] ?? image.array ?? 0}</span>
                              <span>Højest ({arrayBounds.max})</span>
                            </div>
                            <div className="relative">
                              <input
